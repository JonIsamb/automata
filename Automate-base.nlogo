...
globals[
  liste-etats ;; liste des etats de l'automate
  liste-transitions ;; liste de transitions
  nb-points ;; nombre de points
  nb-objects-in-box ;; nb d'objets dnas la boîte
]
turtles-own[
  ...
  bouton-avancer ;; bouleen bouton avancer
  bouton-sauter ;; bouléen bouton sauter
  bouton-stop ;; bouléen bouton stop
  bouton-ramasser ;; booleen bouton ramasser
  bouton-deposer ;; booleen bouton deposer
...
to setup-player
  create-turtles 1 [
    ...
    set next-activity [ -> attendre ]
    set bouton-avancer false
    set bouton-stop false
    set bouton-sauter false
    set bouton-ramasser false
    set bouton-deposer false
    set last-y ycor
...
to go
  ask turtles with [shape = "player"] [
    run next-activity
  ]
  output-print nb-points
end
