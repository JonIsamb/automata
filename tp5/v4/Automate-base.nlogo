; Automate-base.nlogo - Version corrigée TP 5-6
...
to setup
  ...
  print "Utilisez les boutons pour contrôler le personnage"
  print "Objectif: Ramasser les objets jaunes!"
  reset-ticks
end
...
to setup-world
  ...
  ask n-of (world-width * world-height * 0.15) patches with [
    not is-obstacle? and distancexy 0 0 > 2
  ] [
    set pcolor blue
    set is-obstacle? true
  ]
  ask n-of 10 patches with [
    not is-obstacle? and distancexy 0 0 > 3
  ] [
    set pcolor yellow
    set has-treasure? true
  ]
  ask patches with [distancexy 0 0 <= 1.5] [
    set pcolor green
  ]
end
...
to stop-button
  if game-running [
    player-stop
    print "Joueur en pause..."
  ]
end

to quit-button
  print (word "Score final: " score)
  print (word "Mouvements: " moves-count)
  print (word "Objets trouvés: " objects-found)
  print (word "Temps de jeu: " precision (timer - start-time) 1 " secondes")
  quit
end
...
to show-status
  ...
  print (word "Direction: " player-direction " (0=N, 1=E, 2=S, 3=O)")
  print (word "Objet en main: " player-has-object)
